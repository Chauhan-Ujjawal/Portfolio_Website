...
const Services = () => {
    const text = "I don’t just build projects , I craft experiences that speak louder than code."
    ...
    return (
        <section id='services' className='min-h-screen bg-black rounded-t-4xl'>
            <AnimatedHeaderSection subTitle={"Behind the scene, Beyond the screen "} title={"SERVICE"} text={text} textColor={"text-white"} textstyle={"bg-white text-black inline-block px-3 py-1 rounded"} withScrollTrigger={true} />
